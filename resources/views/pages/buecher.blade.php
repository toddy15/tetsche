...
<div class="row">
    ...
    <div class="col-md-6">
        <h2>Tetsche Open Air</h2>
        <p>
            Dokumentation über die Tetsche-Ausstellung in Stade an
            den alten Kaimauern. Alles über das Making-Of, die Cartoons,
            die Objekte und den alten Hafen. 88 Seiten im Hardcover!
        </p>
        <p>
            KJM Buchverlag<br />
        ...
        <p>
            <a href="https://www.kjm-buchverlag.de/produkt/tetsche-open-air/" class="btn btn-danger">KJM Buchverlag</a>
        </p>
        <p>
            <a href="https://www.hugendubel.de/de/buch_gebunden/tetsche_open_air-41677336-produkt-details.html" class="btn btn-danger">Bei Hugendubel ansehen</a>
        </p>
        <p>
            <a href="https://www.thalia.de/shop/home/artikeldetails/A1062314305" class="btn btn-danger">Bei Thalia ansehen</a>
        </p>
        <p>
            <a href="https://www.amazon.de/Tetsche-Open-Air-Cartoons-Objekte/dp/3961941734/" class="btn btn-danger">Bei Amazon ansehen</a>
        </p>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-6">
        <h2>Cartoons &amp; andere Kostbarkeiten</h2>
        <p>
            Das nächste große dicke Tetsche-Buch ist da!<br />
        ...
        <p>
            <a href="https://www.carlsen.de/hardcover/cartoons-und-andere-kostbarkeiten/96575" class="btn btn-danger">Carlsen-Verlag</a>
        </p>
        <p>
            <a href="https://www.hugendubel.de/de/buch_gebunden/tetsche-cartoons_und_andere_kostbarkeiten-32988855-produkt-details.html" class="btn btn-danger">Bei Hugendubel ansehen</a>
        </p>
        <p>
            <a href="https://www.thalia.de/shop/home/artikeldetails/A1049087718" class="btn btn-danger">Bei Thalia ansehen</a>
        </p>
        <p>
